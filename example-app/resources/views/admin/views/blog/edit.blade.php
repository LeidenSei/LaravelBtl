...
@section('content')
    <div class="container-fluid">
        ...
        <div class="shadow-lg p-3 mb-5 bg-body rounded">
            <form action="{{route('blog.update',$blog)}}" enctype="multipart/form-data" method="post" onsubmit="return validate()">
                <div class="row">
                    <div class="col-lg-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" onkeyup="ChangeToSlug()" onkeydown="ChangtoSlug()"
                                 name="name" value="{{$blog->name}}" id="name" class="form-control">
                                @error('name')
                    ...
                    <div class="col-lg-6">
                        <img style="height: 100%; width: 50%; border: 1px solid black;" src="{{asset('storage/images')}}/{{$blog->image}}"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea name="content" id="editor2"   rows="10" cols="80">
                                    {{ old('description') ? old('description') : $blog->content }}
                                </textarea>
                                @error('content')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
