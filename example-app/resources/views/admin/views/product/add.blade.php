                        ...
                        <div class="row">
                            <div class="col-lg-5 mb-5">
                                ...
                                <img style="height: 100%; width: 100%; border: 1px solid black;" src=""
                                    alt="image of product" id="imagePreview">
                            </div>
                            <div class="col-lg-7">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="sale_price" value="{{old('sale_price')}}" id="sale_price" class="form-control">
                                        @error('sale_price')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-6">
                                <div class="ml-4" style="margin-top: 20px;">
                                    <img style="height: 200px; width: 90%;object-fit: cover;" src=""
                                        alt="image of category" id="img_cate">
                                </div>
